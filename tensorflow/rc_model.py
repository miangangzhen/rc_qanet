...
class RCModel(object):
    ...
    def _setup_placeholders(self):
        """
        Placeholders for passage, question, p_len, q_len, span_start, span_end, dropout_keep
        """
    ...
    def _match(self):
        ...
        # [batch_size*max_passage_num, sequence_length, hidden_size*8]
    ...
    def _decode(self):
        ...
        with tf.variable_scope('same_question_concat'):
            ...
            # [batch_size, sequence_length*max_passage_num, hidden_size*2]
        ...
        # start_probs [batch_size, max_passage_num*max_p_len]
