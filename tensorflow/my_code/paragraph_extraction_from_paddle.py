...
if __name__ == "__main__":
    ...
    # mode="train"/"dev"/"test"
    mode = "test"
    tmp_path = TEST_SEARCH_PATH
    with open(os.path.join(ROOT_PATH, tmp_path+"_pe"), "w", encoding="utf-8") as fo:
        with open(os.path.join(ROOT_PATH, tmp_path), "r", encoding="utf-8") as f:
